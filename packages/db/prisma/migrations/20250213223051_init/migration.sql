...
-- CreateEnum
CREATE TYPE "ModelEthinicityEnum" AS ENUM ('Black', 'White', 'SouthAsian', 'AsianAmerican', 'SouthEastAsian', 'Hispanic', 'MiddleEastern', 'Pacific', 'EastAsian');

-- CreateEnum
CREATE TYPE "ModelEyeColorEnum" AS ENUM ('Brow', 'Blue', 'Hazel', 'Grey');
